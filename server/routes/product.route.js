...
router.route('/search/filters')
 .post(productController.searchFiltersController)
router.route('/category/product/:categoryId')
 .get(productController.getProductsByCategoryIdController) 
