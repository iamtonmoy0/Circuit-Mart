...
const CategoryForm = ({handleSubmit,name,button}) => {
	return (
		<>
    ...
    <div className="mt-5 p-4 relative  bg-white border rounded-xl sm:mt-10 md:p-10 dark:bg-gray-800 dark:border-gray-700">
      <form onSubmit={e=>handleSubmit(e)} >
        <div className="mb-4 sm:mb-8">
          <label For="hs-feedback-post-comment-name-1" className="block mb-2 text-sm font-medium dark:text-white"> Name:</label>
        ...
        <div className="mt-6 grid">
          <button type="submit" className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all dark:focus:ring-offset-gray-800">{button}</button>
        </div>
      </form>
    </div>
    {/* End Card */}
