...
import {  REGISTER } from "../../../routes/routePath";
...
{/* helmet */}
			<Helmet>
				<title>Circuit-Mart| Login</title>
			</Helmet>
          ...
          <div className="mt-5">
            ...
            <form onSubmit={(e)=>handleLogin(e)}>
              <div className="grid gap-y-4">
                ...
                <button type="submit" className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800"><GoMail/> Sign in with Email/Password</button>
              </div>
			...
			<button onClick={googleSignIn} type="button" className="w-full mt-5 py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-orange-400 text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-gray-800 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800">
