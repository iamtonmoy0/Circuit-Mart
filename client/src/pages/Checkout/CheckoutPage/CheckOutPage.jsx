...
import { deleteUserCart, getUserCart } from "../../../functions/cartFunctions";
...
this is okeya
				...
				<div className="lg:w-4/12 w-full lg:pl-3 pb-4">
					...
					<button  className="bg-green-400 mt-4 rounded py-2 px-5 font-semibold text-gray-800  inline-flex">Place Order</button>
